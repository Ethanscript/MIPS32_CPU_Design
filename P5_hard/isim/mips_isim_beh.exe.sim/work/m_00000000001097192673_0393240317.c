...
#endif
static const char *ng0 = "C:/Users/Ethan/Desktop/test_code/P5/P5_new/stop.v";
...
LAB33:    memcpy(t90, t63, 8);

LAB34:    memset(t118, 0, 8);
    t119 = (t90 + 4);
...
LAB52:    memcpy(t145, t118, 8);

LAB53:    memset(t173, 0, 8);
    t174 = (t145 + 4);
...
LAB39:    if (*((unsigned int *)t77) < *((unsigned int *)t78))
        goto LAB37;

LAB38:    memset(t82, 0, 8);
    t83 = (t79 + 4);
...
LAB41:    if (*((unsigned int *)t83) != 0)
        goto LAB42;

LAB43:    t91 = *((unsigned int *)t63);
...
LAB58:    if (*((unsigned int *)t132) < *((unsigned int *)t133))
        goto LAB56;

LAB57:    memset(t137, 0, 8);
    t138 = (t134 + 4);
...
LAB77:    if (*((unsigned int *)t187) < *((unsigned int *)t188))
        goto LAB75;
...
LAB96:    if (*((unsigned int *)t242) < *((unsigned int *)t243))
        goto LAB94;

LAB95:    memset(t247, 0, 8);
    t248 = (t244 + 4);
...
LAB98:    if (*((unsigned int *)t248) != 0)
        goto LAB99;

LAB100:    t256 = *((unsigned int *)t228);
...
extern void work_m_00000000001097192673_0393240317_init()
{
	static char *pe[] = {(void *)Cont_31_0};
	xsi_register_didat("work_m_00000000001097192673_0393240317", "isim/mips_isim_beh.exe.sim/work/m_00000000001097192673_0393240317.didat");
