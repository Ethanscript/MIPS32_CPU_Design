...
#endif
static const char *ng0 = "C:/Users/Ethan/Desktop/Zsk/bridge.v";
...
LAB53:    if (*((unsigned int *)t145) > 0)
        goto LAB54;

LAB55:    if (*((unsigned int *)t4) > 0)
        goto LAB56;

LAB57:    memcpy(t3, t154, 8);
...
LAB54:    xsi_vlog_unsigned_bit_combine(t3, 32, t149, 32, t154, 32);
    goto LAB58;

LAB56:    memcpy(t3, t149, 8);
    goto LAB58;
...
LAB49:    if (*((unsigned int *)t104) < *((unsigned int *)t96))
        goto LAB48;

LAB47:    *((unsigned int *)t105) = 1;

LAB48:    memset(t109, 0, 8);
    t110 = (t105 + 4);
...
LAB70:    *((unsigned int *)t168) = 1;

LAB72:    memset(t103, 0, 8);
    t184 = (t168 + 4);
...
LAB76:    t191 = (t103 + 4);
    t192 = *((unsigned int *)t103);
    t193 = *((unsigned int *)t191);
    t194 = (t192 || t193);
    if (t194 > 0)
        goto LAB77;

LAB78:    t197 = *((unsigned int *)t103);
    t198 = (~(t197));
...
LAB80:    if (*((unsigned int *)t191) > 0)
        goto LAB81;

LAB82:    if (*((unsigned int *)t103) > 0)
        goto LAB83;

LAB84:    memcpy(t102, t201, 8);

LAB85:    goto LAB39;

LAB40:    xsi_vlog_unsigned_bit_combine(t3, 32, t97, 32, t102, 32);
    goto LAB44;

LAB42:    memcpy(t3, t97, 8);
    goto LAB44;
...
LAB61:    if (*((unsigned int *)t122) > *((unsigned int *)t121))
        goto LAB60;

LAB59:    *((unsigned int *)t123) = 1;

LAB60:    memset(t127, 0, 8);
    t128 = (t123 + 4);
...
LAB79:    t195 = ((char*)((ng3)));
    memset(t201, 0, 8);
    xsi_vlog_unsigned_unary_minus(t201, 32, t195, 32);
    goto LAB80;

LAB81:    xsi_vlog_unsigned_bit_combine(t102, 32, t196, 32, t201, 32);
    goto LAB85;

LAB83:    memcpy(t102, t196, 8);
    goto LAB85;

}


extern void work_m_00000000001486277629_0249777441_init()
{
	static char *pe[] = {(void *)Cont_39_0,(void *)Cont_40_1,(void *)Cont_41_2,(void *)Cont_42_3,(void *)Cont_43_4,(void *)Cont_44_5};
	xsi_register_didat("work_m_00000000001486277629_0249777441", "isim/test_mips_isim_beh.exe.sim/work/m_00000000001486277629_0249777441.didat");
